# -*- coding: utf-8 -*-
#
# SDdata documentation build configuration file, created by
...
project = u'SDdata'
copyright = u'2014, Kiyoshi Masui'
...
latex_documents = [
  ('index', 'sddata.tex', u'SDdata Documentation',
   u'Kiyoshi Masui', 'manual'),
]
...
man_pages = [
    ('index', 'SDdata', u'SDdata Documentation',
     [u'Kiyoshi Masui'], 1)
]
...
texinfo_documents = [
  ('index', 'SDdata', u'SDdata Documentation',
   u'Kiyoshi Masui', 'SDdata', 'Single Dish Radio Data',
   'Miscellaneous'),
]
